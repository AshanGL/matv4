...
-------------------------------
1. Type-specific solving strategies added per answer type (not just format rules).
2. COMMON_PITFALLS expanded with string/parity/degree/set-specific traps.
3. build_user_prompt: injects domain hints automatically (no separate call needed).
4. build_retry_prompt: differentiated messages per turn range — early/mid/late.
5. Explicit \\boxed{} reminder injected at every retry, not just first nudge.
6. New build_type_recovery_prompt: used when all attempts return low-confidence
   answers — asks the LLM to reconsider its answer type.
7. TOOL_CALL_FORMAT_REMINDER: cleaner, more structured examples.
"""
...
# IMPROVEMENT 1: each type now has both FORMAT and STRATEGY guidance
_TYPE_RULES = {
    "integer": """\
ANSWER TYPE: integer
...
# ─────────────────────────────────────────────────────────────────────────────
# Domain-specific tips (IMPROVEMENT 3: injected automatically)
# ─────────────────────────────────────────────────────────────────────────────
...
# ─────────────────────────────────────────────────────────────────────────────
# User prompt (with knowledge results + domain hints injected)
# ─────────────────────────────────────────────────────────────────────────────
...
def build_user_prompt(
    ...
    domain:            Optional[str] = None,   # IMPROVEMENT 3
) -> str:
    parts = []
    ...
    # IMPROVEMENT 3: domain-specific hints injected automatically
...
# ─────────────────────────────────────────────────────────────────────────────
# Retry prompt (IMPROVEMENT 4: differentiated per turn range)
# ─────────────────────────────────────────────────────────────────────────────
...
# ─────────────────────────────────────────────────────────────────────────────
# Extraction nudge (when LLM solved but forgot \\boxed{})
# ─────────────────────────────────────────────────────────────────────────────
...
# ─────────────────────────────────────────────────────────────────────────────
# IMPROVEMENT 6: type recovery prompt
# Used when all attempts returned low-confidence or mismatched type answers.
# ─────────────────────────────────────────────────────────────────────────────
